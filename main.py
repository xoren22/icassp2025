...
def main():
    ...
    parser.add_argument('--num_workers', type=int, default=8, help='number of workers') # dddddd
    ...
    train_files, val_files = split(inputs_list, split_save_path=split_save_path)
